...
*/}}
{{- define "webrecords.containerName" -}}
{{ include "webrecords.name" . }}
{{- end }}

{{/*
Name of the ConfigMap
*/}}
{{- define "webrecords.configMapName" -}}
{{ include "webrecords.name" . }}
{{- end }}
...
*/}}
{{- define "webrecords.deploymentName" -}}
{{ include "webrecords.name" . }}
{{- end }}
...
*/}}
{{- define "webrecords.selector" -}}
app.kubernetes.io/name: {{ include "webrecords.name" . | quote }}
...
*/}}
{{- define "webrecords.metadata" -}}
labels:
  helm.sh/chart: {{ include "webrecords.chartLabel" . | quote }}
  {{- include "webrecords.selector" . | nindent 2 }}
...
*/}}
{{- define "webrecords.configMapMetadata" -}}
...
{{- $chartMetadata := include "webrecords.metadata" . | fromYaml | deepCopy }}
...
*/}}
{{- define "webrecords.deploymentMetadata" -}}
{{- $commonMetadata := (.Values.common).metadata | default dict | deepCopy }}
...
name: {{ include "webrecords.deploymentName" . | quote }}
{{ toYaml $metadata }}
{{- end }}
...
*/}}
{{- define "webrecords.serviceMetadata" -}}
{{- $commonMetadata := (.Values.common).metadata | default dict | deepCopy }}
...
name: {{ include "webrecords.serviceName" . | quote }}
{{ toYaml $metadata }}
{{- end }}
