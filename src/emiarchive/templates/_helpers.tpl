...
*/}}
{{- define "emiarchive.containerName" -}}
{{ include "emiarchive.name" . }}
{{- end }}

{{/*
Name of the Secret
*/}}
{{- define "emiarchive.secretName" -}}
{{ include "emiarchive.name" . }}
{{- end }}
...
*/}}
{{- define "emiarchive.configMapName" -}}
{{ include "emiarchive.name" . }}
{{- end }}
...
*/}}
{{- define "emiarchive.statefulSetName" -}}
{{ include "emiarchive.name" . }}
{{- end }}
...
*/}}
{{- define "emiarchive.selector" -}}
app.kubernetes.io/name: {{ include "emiarchive.name" . | quote }}
...
*/}}
{{- define "emiarchive.metadata" -}}
labels:
  helm.sh/chart: {{ include "emiarchive.chartLabel" . | quote }}
  {{- include "emiarchive.selector" . | nindent 2 }}
...
*/}}
{{- define "emiarchive.configMapMetadata" -}}
{{- $commonMetadata := (.Values.common).metadata | default dict | deepCopy }}
...
*/}}
{{- define "emiarchive.volumeMetadata" -}}
{{- $commonMetadata := (.Values.common).metadata | default dict | deepCopy }}
...
*/}}
{{- define "emiarchive.statefulSetMetadata" -}}
{{- $commonMetadata := (.Values.common).metadata | default dict | deepCopy }}
...
name: {{ include "emiarchive.statefulSetName" . | quote }}
{{ toYaml $metadata }}
{{- end }}
...
*/}}
{{- define "emiarchive.serviceMetadata" -}}
{{- $commonMetadata := (.Values.common).metadata | default dict | deepCopy }}
...
name: {{ include "emiarchive.serviceName" . | quote }}
{{ toYaml $metadata }}
{{- end }}
