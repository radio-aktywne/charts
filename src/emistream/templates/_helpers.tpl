...
*/}}
{{- define "emistream.containerName" -}}
{{ include "emistream.name" . }}
{{- end }}

{{/*
Name of the ConfigMap
*/}}
{{- define "emistream.configMapName" -}}
{{ include "emistream.name" . }}
{{- end }}
...
*/}}
{{- define "emistream.deploymentName" -}}
{{ include "emistream.name" . }}
{{- end }}
...
*/}}
{{- define "emistream.selector" -}}
app.kubernetes.io/name: {{ include "emistream.name" . | quote }}
...
*/}}
{{- define "emistream.metadata" -}}
labels:
  helm.sh/chart: {{ include "emistream.chartLabel" . | quote }}
  {{- include "emistream.selector" . | nindent 2 }}
...
*/}}
{{- define "emistream.configMapMetadata" -}}
...
{{- $chartMetadata := include "emistream.metadata" . | fromYaml | deepCopy }}
...
*/}}
{{- define "emistream.deploymentMetadata" -}}
{{- $commonMetadata := (.Values.common).metadata | default dict | deepCopy }}
...
name: {{ include "emistream.deploymentName" . | quote }}
{{ toYaml $metadata }}
{{- end }}
...
*/}}
{{- define "emistream.serviceMetadata" -}}
{{- $commonMetadata := (.Values.common).metadata | default dict | deepCopy }}
...
name: {{ include "emistream.serviceName" . | quote }}
{{ toYaml $metadata }}
{{- end }}
