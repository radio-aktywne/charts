...
*/}}
{{- define "emirecords.containerName" -}}
{{ include "emirecords.name" . }}
{{- end }}

{{/*
Name of the Secret
*/}}
{{- define "emirecords.secretName" -}}
{{ include "emirecords.name" . }}
{{- end }}
...
*/}}
{{- define "emirecords.configMapName" -}}
{{ include "emirecords.name" . }}
{{- end }}
...
*/}}
{{- define "emirecords.deploymentName" -}}
{{ include "emirecords.name" . }}
{{- end }}
...
*/}}
{{- define "emirecords.selector" -}}
app.kubernetes.io/name: {{ include "emirecords.name" . | quote }}
...
*/}}
{{- define "emirecords.metadata" -}}
labels:
  helm.sh/chart: {{ include "emirecords.chartLabel" . | quote }}
  {{- include "emirecords.selector" . | nindent 2 }}
...
*/}}
{{- define "emirecords.configMapMetadata" -}}
{{- $commonMetadata := (.Values.common).metadata | default dict | deepCopy }}
...
*/}}
{{- define "emirecords.deploymentMetadata" -}}
{{- $commonMetadata := (.Values.common).metadata | default dict | deepCopy }}
...
name: {{ include "emirecords.deploymentName" . | quote }}
{{ toYaml $metadata }}
{{- end }}
...
*/}}
{{- define "emirecords.serviceMetadata" -}}
{{- $commonMetadata := (.Values.common).metadata | default dict | deepCopy }}
...
name: {{ include "emirecords.serviceName" . | quote }}
{{ toYaml $metadata }}
{{- end }}
