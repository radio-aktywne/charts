...
*/}}
{{- define "mediatunes.containerName" -}}
{{ include "mediatunes.name" . }}
{{- end }}

{{/*
Name of the Secret
*/}}
{{- define "mediatunes.secretName" -}}
{{ include "mediatunes.name" . }}
{{- end }}
...
*/}}
{{- define "mediatunes.configMapName" -}}
{{ include "mediatunes.name" . }}
{{- end }}
...
*/}}
{{- define "mediatunes.statefulSetName" -}}
{{ include "mediatunes.name" . }}
{{- end }}
...
*/}}
{{- define "mediatunes.selector" -}}
app.kubernetes.io/name: {{ include "mediatunes.name" . | quote }}
...
*/}}
{{- define "mediatunes.metadata" -}}
labels:
  helm.sh/chart: {{ include "mediatunes.chartLabel" . | quote }}
  {{- include "mediatunes.selector" . | nindent 2 }}
...
*/}}
{{- define "mediatunes.configMapMetadata" -}}
{{- $commonMetadata := (.Values.common).metadata | default dict | deepCopy }}
...
*/}}
{{- define "mediatunes.volumeMetadata" -}}
{{- $commonMetadata := (.Values.common).metadata | default dict | deepCopy }}
...
*/}}
{{- define "mediatunes.statefulSetMetadata" -}}
{{- $commonMetadata := (.Values.common).metadata | default dict | deepCopy }}
...
name: {{ include "mediatunes.statefulSetName" . | quote }}
{{ toYaml $metadata }}
{{- end }}
...
*/}}
{{- define "mediatunes.serviceMetadata" -}}
{{- $commonMetadata := (.Values.common).metadata | default dict | deepCopy }}
...
name: {{ include "mediatunes.serviceName" . | quote }}
{{ toYaml $metadata }}
{{- end }}
