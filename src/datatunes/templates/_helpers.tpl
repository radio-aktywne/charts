...
*/}}
{{- define "datatunes.containerName" -}}
{{ include "datatunes.name" . }}
{{- end }}

{{/*
Name of the Secret
*/}}
{{- define "datatunes.secretName" -}}
{{ include "datatunes.name" . }}
{{- end }}
...
*/}}
{{- define "datatunes.configMapName" -}}
{{ include "datatunes.name" . }}
{{- end }}
...
*/}}
{{- define "datatunes.statefulSetName" -}}
{{ include "datatunes.name" . }}
{{- end }}
...
*/}}
{{- define "datatunes.selector" -}}
app.kubernetes.io/name: {{ include "datatunes.name" . | quote }}
...
*/}}
{{- define "datatunes.metadata" -}}
labels:
  helm.sh/chart: {{ include "datatunes.chartLabel" . | quote }}
  {{- include "datatunes.selector" . | nindent 2 }}
...
*/}}
{{- define "datatunes.configMapMetadata" -}}
{{- $commonMetadata := (.Values.common).metadata | default dict | deepCopy }}
...
*/}}
{{- define "datatunes.volumeMetadata" -}}
{{- $commonMetadata := (.Values.common).metadata | default dict | deepCopy }}
...
*/}}
{{- define "datatunes.statefulSetMetadata" -}}
{{- $commonMetadata := (.Values.common).metadata | default dict | deepCopy }}
...
name: {{ include "datatunes.statefulSetName" . | quote }}
{{ toYaml $metadata }}
{{- end }}
...
*/}}
{{- define "datatunes.serviceMetadata" -}}
{{- $commonMetadata := (.Values.common).metadata | default dict | deepCopy }}
...
name: {{ include "datatunes.serviceName" . | quote }}
{{ toYaml $metadata }}
{{- end }}
