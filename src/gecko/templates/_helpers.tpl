...
*/}}
{{- define "gecko.selector" -}}
app.kubernetes.io/name: {{ include "gecko.name" . | quote }}
...
*/}}
{{- define "gecko.metadata" -}}
labels:
  helm.sh/chart: {{ include "gecko.chartLabel" . | quote }}
  {{- include "gecko.selector" . | nindent 2 }}
...
*/}}
{{- define "gecko.configMapMetadata" -}}
{{- $commonMetadata := (.Values.common).metadata | default dict | deepCopy }}
...
*/}}
{{- define "gecko.deploymentMetadata" -}}
{{- $commonMetadata := (.Values.common).metadata | default dict | deepCopy }}
...
name: {{ include "gecko.deploymentName" . | quote }}
{{ toYaml $metadata }}
{{- end }}
...
name: {{ include "gecko.serviceName" . | quote }}
{{ toYaml $metadata }}
{{- end }}
