...
data:
  ...
  SCORPION__JANITOR__RETENTION: {{ required "scorpion.janitor.retention is required" ((.Values.scorpion).janitor).retention | quote }}
  SCORPION__LIFETIMES__TOKENS__ACCESS: {{ required "scorpion.lifetimes.tokens.access is required" (((.Values.scorpion).lifetimes).tokens).access | quote }}
  SCORPION__LIFETIMES__TOKENS__REFRESH: {{ required "scorpion.lifetimes.tokens.refresh is required" (((.Values.scorpion).lifetimes).tokens).refresh | quote }}
