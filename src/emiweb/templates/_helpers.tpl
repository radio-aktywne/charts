...
*/}}
{{- define "emiweb.selector" -}}
app.kubernetes.io/name: {{ include "emiweb.name" . | quote }}
...
*/}}
{{- define "emiweb.metadata" -}}
labels:
  helm.sh/chart: {{ include "emiweb.chartLabel" . | quote }}
  {{- include "emiweb.selector" . | nindent 2 }}
...
*/}}
{{- define "emiweb.configMapMetadata" -}}
...
{{- $chartMetadata := include "emiweb.metadata" . | fromYaml | deepCopy }}
...
*/}}
{{- define "emiweb.deploymentMetadata" -}}
{{- $commonMetadata := (.Values.common).metadata | default dict | deepCopy }}
...
name: {{ include "emiweb.deploymentName" . | quote }}
{{ toYaml $metadata }}
{{- end }}
...
name: {{ include "emiweb.serviceName" . | quote }}
{{ toYaml $metadata }}
{{- end }}
