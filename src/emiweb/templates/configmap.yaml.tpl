...
data:
  EMIWEB__SERVER__PORT: {{ required "app.server.port is required" ((.Values.app).server).port | int | quote }}
  EMIWEB__EVENTS__WINDOW: {{ required "app.events.window is required" ((.Values.app).events).window | quote }}
  EMIWEB__EMISHOWS__HTTP__SCHEME: {{ required "app.emishows.http.scheme is required" (((.Values.app).emishows).http).scheme | quote }}
  EMIWEB__EMISHOWS__HTTP__HOST: {{ required "app.emishows.http.host is required" (((.Values.app).emishows).http).host | quote }}
  EMIWEB__EMISHOWS__HTTP__PORT: {{ required "app.emishows.http.port is required" (((.Values.app).emishows).http).port | int | quote }}
  {{- if (((.Values.app).emishows).http).path }}
  EMIWEB__EMISHOWS__HTTP__PATH: {{ .Values.app.emishows.http.path | quote }}
  {{- end }}
  EMIWEB__EMISTREAM__HTTP__SCHEME: {{ required "app.emistream.http.scheme is required" (((.Values.app).emistream).http).scheme | quote }}
  ...
  EMIWEB__EMISTREAM__HTTP__PATH: {{ .Values.app.emistream.http.path | quote }}
  {{- end }}
  ...
  EMIWEB__EMIPASS__HTTP__SCHEME: {{ required "app.emipass.http.scheme is required" (((.Values.app).emipass).http).scheme | quote }}
  ...
  EMIWEB__EMIPASS__HTTP__PATH: {{ .Values.app.emipass.http.path | quote }}
  {{- end }}
  EMIWEB__EMIPASS__WHIP__SCHEME: {{ required "app.emipass.whip.scheme is required" (((.Values.app).emipass).whip).scheme | quote }}
  ...
  EMIWEB__EMIPASS__WHIP__PATH: {{ .Values.app.emipass.whip.path | quote }}
  {{- end }}
