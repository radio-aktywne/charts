...
*/}}
{{- define "emilounge.containerName" -}}
{{ include "emilounge.name" . }}
{{- end }}

{{/*
Name of the Secret
*/}}
{{- define "emilounge.secretName" -}}
{{ include "emilounge.name" . }}
{{- end }}
...
*/}}
{{- define "emilounge.configMapName" -}}
{{ include "emilounge.name" . }}
{{- end }}
...
*/}}
{{- define "emilounge.deploymentName" -}}
{{ include "emilounge.name" . }}
{{- end }}
...
*/}}
{{- define "emilounge.selector" -}}
app.kubernetes.io/name: {{ include "emilounge.name" . | quote }}
...
*/}}
{{- define "emilounge.metadata" -}}
labels:
  helm.sh/chart: {{ include "emilounge.chartLabel" . | quote }}
  {{- include "emilounge.selector" . | nindent 2 }}
...
*/}}
{{- define "emilounge.configMapMetadata" -}}
{{- $commonMetadata := (.Values.common).metadata | default dict | deepCopy }}
...
*/}}
{{- define "emilounge.deploymentMetadata" -}}
{{- $commonMetadata := (.Values.common).metadata | default dict | deepCopy }}
...
name: {{ include "emilounge.deploymentName" . | quote }}
{{ toYaml $metadata }}
{{- end }}
...
*/}}
{{- define "emilounge.serviceMetadata" -}}
{{- $commonMetadata := (.Values.common).metadata | default dict | deepCopy }}
...
name: {{ include "emilounge.serviceName" . | quote }}
{{ toYaml $metadata }}
{{- end }}
