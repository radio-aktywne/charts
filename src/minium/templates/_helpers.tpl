...
*/}}
{{- define "minium.selector" -}}
app.kubernetes.io/name: {{ include "minium.name" . | quote }}
...
*/}}
{{- define "minium.metadata" -}}
labels:
  helm.sh/chart: {{ include "minium.chartLabel" . | quote }}
...
*/}}
{{- define "minium.configMapMetadata" -}}
{{- $commonMetadata := (.Values.common).metadata | default dict | deepCopy }}
...
*/}}
{{- define "minium.statefulSetMetadata" -}}
{{- $commonMetadata := (.Values.common).metadata | default dict | deepCopy }}
...
name: {{ include "minium.statefulSetName" . | quote }}
{{ toYaml $metadata }}
{{- end }}
...
name: {{ include "minium.serviceName" . | quote }}
{{ toYaml $metadata }}
{{- end }}
