...
*/}}
{{- define "jasmine.selector" -}}
app.kubernetes.io/name: {{ include "jasmine.name" . | quote }}
...
*/}}
{{- define "jasmine.metadata" -}}
labels:
  helm.sh/chart: {{ include "jasmine.chartLabel" . | quote }}
  {{- include "jasmine.selector" . | nindent 2 }}
...
*/}}
{{- define "jasmine.configMapMetadata" -}}
{{- $commonMetadata := (.Values.common).metadata | default dict | deepCopy }}
...
*/}}
{{- define "jasmine.deploymentMetadata" -}}
{{- $commonMetadata := (.Values.common).metadata | default dict | deepCopy }}
...
name: {{ include "jasmine.deploymentName" . | quote }}
{{ toYaml $metadata }}
{{- end }}
...
*/}}
{{- define "jasmine.serviceMetadata" -}}
{{- $commonMetadata := (.Values.common).metadata | default dict | deepCopy }}
...
name: {{ include "jasmine.serviceName" . | quote }}
{{ toYaml $metadata }}
{{- end }}
